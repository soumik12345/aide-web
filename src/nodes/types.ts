...
export type IntegerNode = Node<{ label: string; value: number }, 'integer'>;
export type AppNode = BuiltInNode | PositionLoggerNode | AddNode | SubtractNode | MultiplyNode | DivideNode | IntegerNode;
